...
const About = () => {
	return (
		<div
			id="about"
			className="min-h-screen flex flex-col justify-center items-center gap-7 py-20 px-4 sm:px-6 lg:px-8"
		>
			...
			<div className="flex flex-col lg:flex-row justify-center items-center max-w-7xl mx-auto gap-8 lg:gap-16">
				<div className="flex-1 max-w-4xl">
					<p className="text-white text-justify text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-light">
						...
						is back with{" "}
						<span className="font-bold text-[#A0BED3]">HackTU 7.0</span>,
						our flagship event hosted at Thapar Institute of Engineering
						and Technology, Patiala. We're excited to see what innovative
						ideas emerge from this year's event.
					</p>
					<br />
					<p className="text-white text-justify text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-light">
						Whether you're a seasoned developer or new to hackathons,
						there's something for everyone. Development is more than just
						coding—it's an adrenaline rush that drives innovation. Today's
						tech world demands solutions that are both cutting-edge and
						user-friendly.
					</p>
					<br />
					<p className="text-white text-justify text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-light">
						...
						<span className="font-bold text-[#A0BED3]">HackTU 7.0</span> -
						the biggest offline hackathon at TIET!
					</p>
				</div>
